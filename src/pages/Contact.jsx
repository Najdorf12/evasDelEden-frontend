  ...
  return (
    <>
      ...
      >
        ...
        <article
          id="box-glass2" 
          className="flex flex-col justify-center font-text2 items-center z-50 py-6  w-[98%] rounded-2xl border border-zinc-700 shadow-lg shadow-zinc-900 mt-12 lg:shadow-gray-400  max-w-[600px] lg:ml-[20%] xl:mt-0 2xl:mt-12"
        >
          <h6  className="text-7xl text-zinc-800 Custom font-title font-semibold xl:text-9xl 2xl:text-[9rem]">
            CONTACTO
          </h6>
          <p className="mt-2 text-stone-700 text-base font-semibold text-center text-balance lg:text-lg 2xl:text-xl ">
            Contact us to learn about pricing, deployment options and the lorem
            impsum.
          </p>
        </article>
        {/* FORM */}
        <section className="z-50 font-text2 mt-6 lg:ml-[20%] 2xl:mt-8">
          <div
            /* id="box-glass2" */
          ...
          >
            ...
            >
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. In condimentum nisi lorem, ut congue metus efficitur id. Nunc id quam sed lectus bibendum sodales. 
            </p>
            <form method="POST" action="#" className="mt-3 space-y-8 px-6 2 ">
              <div className="relative">
                <input
                  ...
                  className="peer h-10 w-full my-4 border-b-2 border-gray-300 text-white bg-transparent placeholder-transparent focus:outline-none focus:border-primary  lg:text-stone-600 2xl:mt-6"
                  required=""
                  id="email"
                  name="email"
                  type="email"
