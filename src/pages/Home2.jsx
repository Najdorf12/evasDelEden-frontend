        ...
        <section className="w-full flex flex-col items-center z-50 pb-3 xl:pb-4">
          ...
          {evasByCategory?.Platinum?.length > 0 && (
            ...
            >
              ...
              <div className="mt-6 flex flex-wrap justify-start gap-1 md:gap-3 lg:mt-3">
          ...
          {evasByCategory?.Gold?.length > 0 && (
            <div
              id="gold-section"
              className="mt-16 flex flex-col w-full px-2 min-h-[300px] items-start justify-start lg:mt-20"
            >
              ...
              <div className="mt-6 flex flex-wrap justify-start gap-1 md:gap-3">
